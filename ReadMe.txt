...
TODO:
1. Добить позиционирование сообщений в чате;
2. Попробовать запустить клиента на виртуальной машине;
3. Сделать буфер размером 32kB, и проветрить фрагментацию IP-пакетов в Wireshark;
4. Почитать про IPsec VPN. Особенно интересуют порты, на которых он работает;
